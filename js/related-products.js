...
window.addEventListener('load', function () {
  ...
  new Glider (document.querySelector('.relacionados__container--carousel'), {

      slidesToShow: 1,
      slidesToScroll: 1,
      draggable: true,
      dots: '.relacionados__indicators',
      rewind: true,
      duration: 0.6,
      arrows: {
          prev: '.relacionados__container--left',
          next: '.relacionados__container--right'
      },
